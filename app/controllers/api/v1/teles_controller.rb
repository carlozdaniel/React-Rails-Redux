class Api::V1::TelesController < ApplicationController
  ...
  def create
    ...
    if @tele.save
      render json: @tele, status: :created#, location: @tele
    else
  ...
  private
    ...
    def tele_params
      params.require(:tele).permit(:controles_redmecanismo_seg, :segregacion_redes, :procedimientos, :intercambio, :mensajeria, :confidencialidad, :empresa_id)
    end
end
