...
class PoliticasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create politica" do
    assert_difference('Politica.count') do
      post politicas_url, params: { politica: { conunto_politicas: @politica.conunto_politicas, revision_politica: @politica.revision_politica } }, as: :json
    end
  ...
  test "should update politica" do
    patch politica_url(@politica), params: { politica: { conunto_politicas: @politica.conunto_politicas, revision_politica: @politica.revision_politica } }, as: :json
    assert_response 200
  end
